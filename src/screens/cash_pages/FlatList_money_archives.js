                ...
                renderItem={({ item }) =>
                    <>
                        ...
                        justifyContent:"space-around"
                            ...
                            <View style={{ justifyContent: 'space-between', marginLeft: hp(-4),paddingVertical:hp(1)
                        ,height :h*0.14
                        }}>
                            ...
                            <Text style={{
                                 fontFamily: FONT.font_Almarai_Bold,
                                  color: COLORS.green_mid, fontSize: RFValue(18, h) }}>{item.status}</Text>
                            <Text style={{
                                 fontFamily: FONT.font_Almarai_Bold,
                                 color: COLORS.black, fontSize: RFValue(18, h) }}>EG 0.00</Text>
